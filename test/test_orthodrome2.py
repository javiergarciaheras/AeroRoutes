...
class TestOrthodrome2(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.orthodrome = ComputeOrto([KSFO_lon, KSFO_lat], [LEMD_lon, LEMD_lat], 100)
    ...
    def test_get_latitude(self):
        lat = self.orthodrome.get_latitude(-50)
    ...
    def test_plot_Lamber_Conformal(self):
        ...
        plot_routes(self.orthodrome.lon_deg, self.orthodrome.lat_deg,
